...
<html>
   <head>
      ...
      <link href="<?php echo SITE_URL .'css/style.css?v='. ANE_VERSAO; ?>" rel="stylesheet">
   ...
   <body>
      ...
      <script src="<?php echo SITE_URL .'js/funcoes.js?v='. ANE_VERSAO; ?>"></script>
   </body>
</html>
